    ...
    <section className="relative z-10 bg-gray-light py-16 dark:bg-bg-color-dark md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Hikani Foundation s'engage à transformer des vies grâce à l'éducation et au soutien communautaire. Découvrez les témoignages de ceux que nous avons aidés."
          center
        />
